...
project = 'Station Exchange Format'
...
#
html_title = 'Station Exchange Format'
...
latex_documents = [
    (master_doc, 'SEF.tex', 'SEF Documentation',
...
man_pages = [
    (master_doc, 'SEF', 'SEF Documentation',
     [author], 1)
]
